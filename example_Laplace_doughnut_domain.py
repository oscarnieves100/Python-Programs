# -*- coding: utf-8 -*-
"""
Uses bvp_solver.py to solve Laplace's equation on a circular domain with a
...
# Insert hole
Omega.insert_hole( bvp.Circle(X,Y,diameter/2,dx,dy,x0,y0) )
...
boundary_values_list = [BC_func(X,Y,0), BC_func(X,Y,np.pi/6)]
